      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="ghost" size="sm" onClick={onQuit} className="ml-4" aria-label="Zakończ quiz">
              <X className="h-5 w-5" />
            </Button>
          </div>
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Pytanie nr {currentQuestionIndex + 1} w tej sesji</p>
          </div>
        </div>
