...
Session Notes:
<session_notes>
@22-asystent-planowania-UI-rezultat
</session_notes>
...
Końcowy rezultat powinien składać się wyłącznie z architektury UI w formacie Markdown w języku polskim.
Zapisz ten plan w pliku docs/24-ui-plan.md.
Nie powielaj ani nie powtarzaj żadnej pracy wykonanej w bloku myślenia.
