...
Końcowy wynik powinien składać się wyłącznie z definicji typów DTO i Command Model.
Końcowy wynik zapisz do pliku src/types/dto.ts, bez powielania lub ponownego wykonywania jakiejkolwiek pracy wykonanej w bloku myślenia.
