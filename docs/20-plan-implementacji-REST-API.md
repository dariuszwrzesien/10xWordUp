...
5. Implementation rules:
   ...
   @backend.mdc @astro.mdc @shared.mdc
   </implementation_rules>
...
Pamiętaj, aby zapisać swój plan wdrożenia jako docs/20implementation-plan-REST-API.md. Upewnij się, że plan jest szczegółowy, przejrzysty i zapewnia kompleksowe wskazówki dla zespołu programistów.
```
